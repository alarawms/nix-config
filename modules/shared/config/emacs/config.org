...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Mohammed"
    user-mail-address "m@malarawi.sa")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/alarawms/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/alarawms/bin" "/profile/bin" "/Users/alarawms/.npm-packages/bin" "/Users/alarawms/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
